...
class FBRedshiftEnumUDFOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        current_state = self.hook.get_records('SELECT * FROM airflow_staging_scrapes.enums_translations;');
        ...
        # part 3: self.hook.run(sql, autocommit=True)
